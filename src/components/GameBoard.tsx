...
// import { startGame, setPlayerMove, randomlySetComputerMove, finalizeGameResults, getGameResults, getComputerMove } from '../api/gameService';
...
//             {!gameStarted ? (
//                 <button className="dc-btn" onClick={handleStartGame}>Start Game</button>
//             ) : (
//                 <>
